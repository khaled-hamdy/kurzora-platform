...
// Complete Telegram connection interface for Professional users
...
const TelegramConnection: React.FC<TelegramConnectionProps> = ({
  ...
  const handleConnect = async () => {
    ...
    setConnecting(true);
    const success = await updateTelegramChatId(chatIdInput.trim());
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1">
            <h4 className="font-medium text-white mb-2">Open Telegram Bot</h4>
            <p className="text-slate-400 text-sm mb-3">
              Click the button below to open our trading signals bot in Telegram
            </p>
            <Button
        ...
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1">
            <h4 className="font-medium text-white mb-2">Get Your Chat ID</h4>
            <p className="text-slate-400 text-sm mb-3">
            ...
            <div className="space-y-3">
              ...
              <div className="flex space-x-2">
                <Button
                  ...
                  disabled={!chatIdInput.trim() || connecting}
      ...
      <Alert className="bg-blue-500/10 border-blue-500/20">
        ...
        <AlertDescription className="text-blue-200">
          Your Chat ID is unique to your Telegram account and allows us to send
          alerts directly to you. We never share this information or use it for
          any purpose other than delivering trading signals.
        </AlertDescription>
      </Alert>
    </div>
  );
  ...
  const ConnectedStatus = () => (
    <div className="space-y-6">
      <div className="text-center p-6 bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-lg border border-green-500/20">
        ...
        <p className="text-slate-300">
          You'll receive instant alerts for signals scoring 80% or higher
        </p>
      </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-slate-800/50 p-4 rounded-lg">
            <div className="flex items-center justify-between">
              <span className="text-slate-400 text-sm">Alerts (7 days)</span>
  ...
  const UpgradePrompt = () => (
    <div className="text-center p-8 bg-gradient-to-r from-purple-500/10 to-blue-500/10 rounded-lg border border-purple-500/20">
      <Crown className="h-16 w-16 mx-auto mb-4 text-purple-400" />
      <h3 className="text-xl font-semibold text-white mb-2">
        Upgrade to Professional
      </h3>
      <p className="text-slate-300 mb-6">
        Get instant Telegram alerts for high-probability trading signals. Never
        miss a profitable opportunity again.
      </p>
