...
import { Shield, TrendingUp, Signal, Zap, Users, Award, BarChart3, ChevronRight, Menu, X, Check, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <div className="hidden md:flex space-x-4 lg:space-x-6">
              <Link to="/how-it-works" className="text-slate-300 hover:text-white transition-colors text-sm lg:text-base">
                {t('nav.howItWorks')}
              </Link>
              <a href="#testimonials" className="text-slate-300 hover:text-white transition-colors text-sm lg:text-base">{t('landing.testimonials')}</a>
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="max-w-4xl mx-auto">
            <div className="mb-4 sm:mb-6">
              ...
              <p className="text-emerald-400 text-lg sm:text-xl lg:text-2xl font-medium mt-1">{t('landing.aiSignalsSmarter')}</p>
            </div>
            
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 sm:mb-6 leading-tight">
              {t('landing.aiPoweredTrading')}
              <span className="text-blue-400 block">{t('landing.intelligencePlatform')}</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-12">
            ...
            <div className="bg-slate-900/50 backdrop-blur-sm border border-blue-800/30 rounded-lg p-6 sm:p-8 hover:bg-slate-900/70 transition-all duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-white mb-3 sm:mb-4">Risk Management</h3>
              <p className="text-slate-400 text-sm sm:text-base">
            ...
            <div className="bg-slate-900/50 backdrop-blur-sm border border-blue-800/30 rounded-lg p-6 sm:p-8 hover:bg-slate-900/70 transition-all duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-white mb-3 sm:mb-4">Validation & Scoring</h3>
              <p className="text-slate-400 text-sm sm:text-base">
            ...
            <div className="bg-slate-900/50 backdrop-blur-sm border border-blue-800/30 rounded-lg p-6 sm:p-8 hover:bg-slate-900/70 transition-all duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-white mb-3 sm:mb-4">AI Enhancement</h3>
              <p className="text-slate-400 text-sm sm:text-base">
          ...
          <div className="mb-12">
            <h3 className="text-2xl sm:text-3xl font-bold text-white mb-6 text-center">Understanding Signal Scores</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="p-4 bg-gradient-to-r from-emerald-900/50 to-emerald-800/30 rounded-lg border border-emerald-700">
                <div className="flex items-center mb-2">
                  ...
                  <h4 className="text-lg font-semibold text-white">Strong (80-100)</h4>
                </div>
              ...
              <div className="p-4 bg-gradient-to-r from-blue-900/50 to-blue-800/30 rounded-lg border border-blue-700">
                <div className="flex items-center mb-2">
                  <span className="text-2xl mr-2">✅</span>
                  <h4 className="text-lg font-semibold text-white">Valid (60-79)</h4>
                </div>
                <p className="text-slate-300 text-sm">
              ...
              <div className="p-4 bg-gradient-to-r from-yellow-900/50 to-yellow-800/30 rounded-lg border border-yellow-700">
                <div className="flex items-center mb-2">
                  ...
                  <h4 className="text-lg font-semibold text-white">Weak (40-59)</h4>
                </div>
                <p className="text-slate-300 text-sm">
              ...
              <div className="p-4 bg-gradient-to-r from-red-900/50 to-red-800/30 rounded-lg border border-red-700">
                <div className="flex items-center mb-2">
                  <span className="text-2xl mr-2">🚫</span>
                  <h4 className="text-lg font-semibold text-white">Ignore (0-39)</h4>
                </div>
                <p className="text-slate-300 text-sm">
          ...
          <div className="bg-slate-900/50 backdrop-blur-sm border border-blue-800/30 rounded-lg p-6 sm:p-8 text-center">
            <div className="max-w-4xl mx-auto">
              <h3 className="text-2xl sm:text-3xl font-bold text-white mb-4">Ready to Transform Your Trading?</h3>
              <p className="text-slate-300 text-base sm:text-lg mb-6 leading-relaxed">
                Join thousands of traders already profiting with Kurzora's AI-powered signals. Experience the power of institutional-grade analysis combined with Shariah-compliant trading principles.
              </p>
      ...
      <div className="px-4 py-8">
        <p className="text-xs text-slate-500 text-center max-w-3xl mx-auto">
          *Average returns based on members who follow all signals with proper position sizing. Individual results vary. Past performance doesn't guarantee future results. {t('legal.tradingInvolves')}.
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                <li><a href="#" onClick={handleFooterLinkClick} className="hover:text-white transition-colors">{t('footer.home')}</a></li>
                <li><Link to="/how-it-works" onClick={handleFooterLinkClick} className="hover:text-white transition-colors">{t('footer.howItWorks')}</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                <li><Link to="/contact" onClick={handleFooterLinkClick} className="hover:text-white transition-colors">{t('footer.contact')}</Link></li>
                <li><a href="https://discord.gg/kurzora" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">{t('footer.discord')}</a></li>
                <li><a href="https://x.com/KurzoraPlatform" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">{t('footer.twitter')}</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                <li><Link to="/privacy-policy" onClick={handleFooterLinkClick} className="hover:text-white transition-colors">{t('footer.privacyPolicy')}</Link></li>
                <li><Link to="/terms-of-service" onClick={handleFooterLinkClick} className="hover:text-white transition-colors">{t('footer.termsOfService')}</Link></li>
                <li><Link to="/risk-disclosure" onClick={handleFooterLinkClick} className="hover:text-white transition-colors">{t('footer.riskDisclosure')}</Link></li>
                <li><Link to="/shariah-compliance" onClick={handleFooterLinkClick} className="hover:text-white transition-colors">{t('footer.shariahCompliance')}</Link></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-blue-800/30 pt-6 sm:pt-8 mt-6 sm:pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              <div className="flex space-x-4 text-xs text-slate-400">
                <a href="#" onClick={handleFooterLinkClick} className="hover:text-white transition-colors">{t('footer.gdprCompliance')}</a>
                <a href="#" onClick={handleFooterLinkClick} className="hover:text-white transition-colors">{t('footer.cookieNotice')}</a>
              </div>
            </div>
          </div>
        </div>
