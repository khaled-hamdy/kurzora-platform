 ...
 */ export class ScanningConfiguration {
   ...
   */ constructor() {
    ...
    this.settings = {
      useBacktest: false,
      testStocks: ["AAPL", "MSFT", "GOOGL", "JPM", "JNJ"],
      timeframeConfig: {
        "1H": {
          weight: 0.4,
          periods: 50,
      ...
      dateRangeSettings: {
        backtestStart: "2024-05-06",
        backtestEnd: "2024-06-14",
        calendarDays: 400,
      },
    };
    console.log(
 ...
 */ export function getUseBacktest() {
